...
.mySlides {display: none}
  ...
  <div class="row">
      ...
      <div class="col-md-9 personal-info">
        ...
        <form id="update-form" class="form-horizontal" role="form" action="<?php echo SERVER_SIT_SITE ; ?>update/update.php" method="post">
          <div class="form-group">
            <label class="col-lg-3 control-label">Nombre:</label>
            <div class="col-lg-8">
              <input class="form-control" name="nombre"  type="text" value="<?php echo $userDetails['nombre']; ?>">
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label">Telefono:</label>
            <div class="col-lg-8">
              <input class="form-control" name="telefono" type="text" value="<?php echo $userDetails['telefono']; ?>">
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label">Email:</label>
            <div class="col-lg-8">
              <input class="form-control" name="email" type="text" value="<?php echo $userDetails['email']; ?>">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-8">
              <input class="form-control" name="password" type="password" value="<?php echo $userDetails['password']; ?>">
            </div>
          </div>
          <div class="form-group">
            <label class="col-md-3 control-label"></label>
            <div class="col-md-8">
              <input type="submit" class="btn btn-primary" value="Actualizar datos" name="enviar" >
